...
\begin{center}
	\begin{tabular}{|p{0.1\columnwidth}|p{0.2\columnwidth}|p{0.6\columnwidth}|}
		...
		\cline {2-3}
			& Autres & AC3, AMR, Apple Lossless, ATRAC, CELT, FLAC, iLBC, Monkey's Audio, µ-law, Musepack, Nellymoser, OptimFROG, Opus, RealAudio, RTAudio, SHN, Siren, Speex, TAK, Vorbis, WavPack, WMA\\
		\hline
...
Cependant il existe tout de même des astuces pour pouvoir utiliser cette méthode de compression pour compresser les normal map.
