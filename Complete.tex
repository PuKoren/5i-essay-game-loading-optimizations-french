...
%------------------------------------------------
\newpage
\section*{Optimisation par l'organisation des fichiers}
...
Cependant, les chargements sont appliqués de manière assez brutale, le jeu étant bloqué en attendant la réception des données. Rockstar a donc échoué à proposer un chargement fluide malgré l'adaptation du level design, peut être par manque de temps car tout était prévu pour avoir un chargement effectué en tâche de fond.
